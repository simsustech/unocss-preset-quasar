...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [/^q-dialog__title$/, componentClass('q-dialog__title', ``)],
  ...
  [/^q-dialog__inner--square$/, componentClass('q-dialog__inner--square', ``)],
  [
  ...
  [
    ...
    staticClass(
      `[&>div]:(h-full w-full max-h-100vh max-w-100vw top-0! left-0!)
    `
    )
  ],
  [
...
`
  ...
  [
    ...
    componentClass(
      'q-dialog__backdrop',
      `-z-1 pointer-events-all outline-0
    `
    )
  ],
  [
