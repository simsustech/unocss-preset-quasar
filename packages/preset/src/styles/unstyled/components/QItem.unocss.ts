...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [
    ...
    componentClass(
      'q-item',
      qe`min-h-[28px] px-[16px] py-[8px] [transition:color_0.3s,_background-color_0.3s] [&_>_.q-item__section--thumbnail:first-child]:(-ml-[16px]) [&_>_.q-focus-helper_+_.q-item__section--thumbnail]:(-ml-[16px]) [&_>_.q-item__section--thumbnail:last-of-type]:(-mr-[16px]) relative`
    )
  ],
