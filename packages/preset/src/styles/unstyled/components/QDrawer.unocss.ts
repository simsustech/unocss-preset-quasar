...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    /^q-drawer-container$/,
    staticClass(
      `[&:not(.q-drawer--mini-animate)_.q-drawer--mini]:(!p-0) [&:not(.q-drawer--mini-animate)_.q-drawer--mini_.q-item]:(text-center justify-center pl-0 pr-0 min-w-[0])`
    )
  ],
