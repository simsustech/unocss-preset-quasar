...
/**
 * The base component tree. ONE set of shortcuts shared by every style;
 * style differences live in the token entries (`theme.quasar.tokens`).
 * This is the only tree the preset registers — styles are not bases.
 */
