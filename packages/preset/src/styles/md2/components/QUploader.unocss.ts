...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [
    ...
    componentClass(
      'q-uploader',
      `[box-shadow:0_1px_5px_rgba(0,_0,_0,_0.2),_0_2px_2px_rgba(0,_0,_0,_0.14),_0_3px_1px_-2px_rgba(0,_0,_0,_0.12)] [border-radius:var(--q-radius-sm)] align-top bg-[#fff] relative w-[320px] max-h-[320px]`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-uploader__file--img',
      qe`text-[#fff] h-[200px] min-w-[200px] bg-[50%_50%] bg-no-repeat [&:before]:(content-[none]) [&_.q-circular-progress]:(text-[#fff]) [&_.q-uploader__file-header]:(pb-[24px] bg-[linear-gradient(_to_bottom,_rgba(0,_0,_0,_0.7)_20%,_rgba(255,_255,_255,_0)_)])`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-uploader__file-header',
      `relative px-[8px] [padding-block:var(--q-space-xs)] [border-top-left-radius:inherit] [border-top-right-radius:inherit]`
    )
  ],
  ...
  [
    ...
    componentClass('q-uploader__subtitle', `[font-size:var(--q-font-sm)] leading-normal`)
  ],
