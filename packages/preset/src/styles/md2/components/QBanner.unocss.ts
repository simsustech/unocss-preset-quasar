...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [
    /^q-banner$/,
    componentClass('q-banner', `min-h-[54px] px-[16px] py-[8px] bg-[#fff]`)
  ],
  ...
  [
    ...
    componentClass(
      'q-banner__avatar',
      qe`!flex-initial !min-w-[1px] [&_>_.q-avatar]:(text-[46px]) [&_>_.q-icon]:(text-[40px]) [&:not(:empty)_+_.q-banner__content]:(pl-[16px])`
    )
  ],
