...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      'q-timeline__dot',
      `absolute top-[0] bottom-[0] w-[15px] [&_.q-timeline-entry__dot-inner]:(bg-current block absolute) [&_.q-timeline-entry__dot-line]:(bg-current block absolute) [&_.q-timeline-entry__dot-inner]:(border-[3px] border-solid border-[transparent] rounded-[100%] h-[15px] w-[15px] top-[4px] left-[0] [transition:background_0.3s_ease-in-out,_border_0.3s_ease-in-out]) [&_.q-timeline-entry__dot-line]:(w-[3px] opacity-40 top-[24px] bottom-[0] left-[6px]) [&_.q-icon]:(absolute top-[0] left-[0] right-[0] text-[16px] h-[38px] leading-[38px] w-full text-[#fff]) [&_.q-icon_>_svg]:(w-[1em] h-[1em]) [&_.q-icon_>_img]:(w-[1em] h-[1em])`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-timeline__entry--icon',
      qe`[&_.q-timeline__dot]:(w-[31px]) [&_.q-timeline__dot:before]:(h-[31px] w-[31px]) [&_.q-timeline__dot:after]:(top-[41px] left-[14px]) [&_.q-timeline__subtitle]:(pt-[8px])`
    )
  ],
