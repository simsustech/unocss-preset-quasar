...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [/^q-timeline__content$/, mdComponent('q-timeline__content', `pb-[24px]`)],

  [/^q-timeline__title$/, mdComponent('q-timeline__title', `mt-0 mb-[16px]`)],
  ...
  [
    ...
    mdComponent('q-timeline__heading-title', `px-[0] py-[32px] m-0`)
  ],
