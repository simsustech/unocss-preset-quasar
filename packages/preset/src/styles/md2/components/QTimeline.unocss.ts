...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      'q-timeline__subtitle',
      `[font-size:var(--q-font-sm)] mb-[8px] opacity-60 uppercase tracking-[1px] font-bold`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-timeline__dot-img',
      `absolute top-[4px] left-[0] right-[0] h-[31px] w-[31px] bg-current [border-radius:var(--q-radius-circle)]`
    )
  ],
