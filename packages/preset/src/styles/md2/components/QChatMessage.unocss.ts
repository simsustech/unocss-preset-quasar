...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [/^q-message-name$/, staticClass(`text-[small]`)],
  ...
  [/^q-message-avatar--received$/, staticClass(`mr-[8px]`)],
  ...
  [/^q-message-text-content--received$/, staticClass(`text-[#000]`)],

  [/^q-message-name--sent$/, staticClass(`text-right`)],

  [/^q-message-avatar--sent$/, staticClass(`ml-[8px]`)],

  [/^q-message-container--sent$/, staticClass(`flex-row-reverse`)],
  ...
  [/^q-message-text-content--sent$/, staticClass(`text-[#000]`)],
