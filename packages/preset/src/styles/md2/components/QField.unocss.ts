...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [/^q-field--with-bottom$/, mdStatic(`pb-[20px]`)],
  ...
  [
    ...
    mdComponent(
      'q-field__native',
      `font-normal leading-[28px] tracking-[0.00937em] [text-decoration:inherit] [text-transform:inherit] border-none rounded-none bg-transparent text-black/87 outline-none px-[0] w-full min-w-[0] !outline-none select-auto 
	[&:-webkit-autofill]:() 
  ...
  [
	...
	[&_.q-field\\_\\_control_>_div]:(!outline-none) 
	[&_.q-field\\_\\_control_>_div_*]:(!outline-none)`
    )
  ],
