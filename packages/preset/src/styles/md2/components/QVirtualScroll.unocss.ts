...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [/^q-virtual-scroll:focus$/, staticClass(`focus:outline-0`)],
  ...
  [
    ...
    componentClass(
      'q-virtual-scroll--horizontal',
      qe`flex flex-row flex-nowrap items-stretch [&_.q-virtual-scroll__content]:(flex flex-row flex-nowrap) [&_.q-virtual-scroll__padding]:(flex-[0_0_auto]) [&_.q-virtual-scroll__content]:(flex-[0_0_auto]) [&_.q-virtual-scroll__content_>_*]:(flex-[0_0_auto]) [&_.q-virtual-scroll__padding]:(bg-[linear-gradient(_to_left,_rgba(255,_255,_255,_0),_rgba(255,_255,_255,_0)_20%,_rgba(128,_128,_128,_0.03)_20%,_rgba(128,_128,_128,_0.08)_50%,_rgba(128,_128,_128,_0.03)_80%,_rgba(255,_255,_255,_0)_80%,_rgba(255,_255,_255,_0)_)] [background-size:var(--q-virtual-scroll-item-width,_50px)_var(--q-virtual-scroll-item-height,_100%)])`
    )
  ]
]
