...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [
    ...
    componentClass(
      'q-item',
      qe`flex flex-nowrap min-h-[48px] px-[16px] py-[8px] [color:inherit] [transition:color_0.3s,_background-color_0.3s] [&_>_.q-item__section--thumbnail:first-child]:(-ml-[16px]) [&_>_.q-focus-helper_+_.q-item__section--thumbnail]:(-ml-[16px]) [&_>_.q-item__section--thumbnail:last-of-type]:(-mr-[16px]) relative
  ...
  [
    ...
    componentClass(
      'q-item__section--main',
      qe`w-auto min-w-[0] max-w-full flex-[10000_1_0%] [&_+_.q-item__section--main]:(ml-[8px]) [&_~_.q-item__section--side]:(items-end pr-0 pl-[16px])`
    )
  ],
  ...
  [/^q-item--dense$/, staticClass(`min-h-[32px] px-[16px] py-[2px]`)],
  ...
  [/^q-item--active$/, staticClass(`text-primary`)]
]
