...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      'q-checkbox__bg',
      `select-none top-1/4 left-1/4 w-1/2 h-1/2 [border-width:2px] border-solid border-[currentColor] rounded-[2px] [transition:background_0.22s_cubic-bezier(0,_0,_0.2,_1)_0ms]`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-checkbox__inner',
      `mr-2px text-[40px] w-[1em] min-w-[1em] h-[1em] outline-[0] [border-radius:var(--q-radius-circle)] text-[rgba(0,_0,_0,_0.54)]`
    )
  ],
  ...
  [
    ...
    componentClass(
      ...
      qe`[&_.q-checkbox__inner]:(text-[rgba(255,_255,_255,_0.7)])
       ...
       [&_.q-checkbox__inner--truthy]:(text-primary)
       [&_.q-checkbox__inner--indet]:(text-primary)`
    )
  ],
