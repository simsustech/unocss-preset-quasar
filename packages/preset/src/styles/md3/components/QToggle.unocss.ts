...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      'q-toggle__thumb',
      qe`layer-components:text-$light-surface-container-highest layer-components:dark:text-$dark-surface-container-highest
    ...
    [&_.q-icon]:(z-2 layer-components:text-[0.33em] layer-components:text-[#000] opacity-[0.54])`
    )
  ],
  ...
  [
    ...
    componentClass(
      ...
      [&_.q-toggle__thumb:after]:(layer-components:!bg-$light-on-primary dark:!bg-$dark-on-primary)
      [&_.q-toggle__thumb_.q-icon]:(layer-components:text-[#fff] opacity-100)`
    )
  ],
