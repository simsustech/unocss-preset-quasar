...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [/^q-item__section--nowrap$/, mdStatic(`whitespace-nowrap`)],
  ...
  [
    ...
    mdComponent('q-item__label--overline', `text-[rgba(0,_0,_0,_0.7)]`)
  ],

  [
    /^q-item__label--caption$/,
    mdComponent('q-item__label--caption', `text-[rgba(0,_0,_0,_0.54)]`)
  ],
  ...
  [/^q-item--dense$/, mdStatic(`min-h-[28px] px-[16px] py-[2px]`)],
  ...
  [/^q-item--active$/, mdStatic(`text-$light-primary dark:text-$dark-primary`)]
]
