...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      'q-checkbox__inner',
      `text-[40px] w-[1em] min-w-[1em] h-[1em] outline-[0] rounded-[2px] text-$light-on-surface-variant dark:text-$dark-on-surface-variant inline-flex items-center justify-center`
    )
  ],
