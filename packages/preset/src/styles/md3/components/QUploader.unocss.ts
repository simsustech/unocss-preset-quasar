...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    /^q-uploader__spinner$/,
    mdComponent('q-uploader__spinner', `text-[24px] mr-[4px]`)
  ],

  [
    /^q-uploader__header-content$/,
    mdComponent('q-uploader__header-content', `p-[8px]`)
  ],
  ...
  [/^q-uploader__file-header-content$/, mdStatic(`pr-[8px]`)],

  [/^q-uploader__file-status$/, mdStatic(`text-[24px] mr-[4px]`)],

  [
    /^q-uploader__title$/,
    mdComponent('q-uploader__title', `text-[14px] font-bold leading-[1.285714]`)
  ],

  [
    /^q-uploader__subtitle$/,
    mdComponent('q-uploader__subtitle', `text-[12px] leading-normal`)
  ],
