...
const shortcuts: UserShortcuts<QuasarTheme> = [
  ...
  [
    ...
    ([, c], { theme }) =>
      ...
      [&_>_.q-list_>_.q-router-link--exact-active]:(bg-light-secondary-container dark:bg-dark-secondary-container text-light-on-secondary-container dark:text-dark-on-secondary-container)`
  ]
]
