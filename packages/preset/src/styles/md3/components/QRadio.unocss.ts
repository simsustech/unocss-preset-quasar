...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [
    ...
    componentClass(
      ...
      [color:var(--q-primary)] dark:[color:var(--q-primary)]`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-radio__inner',
      `text-[40px] w-[1em] min-w-[1em] h-[1em] outline-[0] [border-radius:var(--q-radius-circle)]
      [color:var(--q-on-surface-variant)] dark:[color:var(--q-on-surface-variant)]`
    )
  ],
