...
const stepperStandard = `[box-shadow:0_1px_5px_rgba(0,_0,_0,_0.2),_0_2px_2px_rgba(0,_0,_0,_0.14),_0_3px_1px_-2px_rgba(0,_0,_0,_0.12)] [border-radius:var(--q-radius-xs)]`
...
const shortcuts: Shortcut<QuasarTheme>[] = [
  [
    ...
    componentClass(
      'q-stepper',
      `${stepperStandard}
      [background-color:var(--q-surface)] dark:[background-color:var(--q-surface)]
      `
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-stepper__caption',
      `[font-size:var(--q-font-sm)] leading-[1.16667]`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-stepper__tab',
      `[padding-inline:var(--q-space-xl)] [padding-block:var(--q-space-sm)] [font-size:var(--q-font-md)] text-[#9e9e9e] flex-row`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-stepper--dark',
      qe`[box-shadow:0_1px_5px_rgba(255,_255,_255,_0.2),_0_2px_2px_rgba(255,_255,_255,_0.14),_0_3px_1px_-2px_rgba(255,_255,_255,_0.12)] 
      [&_.q-stepper__dot_span]:(text-[#000]) [&.q-stepper--bordered]:(border-[rgba(255,_255,_255,_0.28)]) 
      [&_.q-stepper__header--border]:(border-[rgba(255,_255,_255,_0.28)]) 
      [&.q-stepper--horizontal_.q-stepper__line:before]:(bg-[rgba(255,_255,_255,_0.28)])
      [&.q-stepper--horizontal_.q-stepper__line:after]:(bg-[rgba(255,_255,_255,_0.28)]) 
      [&.q-stepper--vertical_.q-stepper__dot:before]:(bg-[rgba(255,_255,_255,_0.28)]) 
      [&.q-stepper--vertical_.q-stepper__dot:after]:(bg-[rgba(255,_255,_255,_0.28)]) 
      [&_.q-stepper__tab--disabled]:(text-[rgba(255,_255,_255,_0.28)]) 
      [&_.q-stepper__tab--disabled_.q-stepper__dot]:(bg-[rgba(255,_255,_255,_0.28)]) 
      [&_.q-stepper__tab--disabled_.q-stepper__label]:(text-[rgba(255,_255,_255,_0.54)])`
    )
  ],
  ...
  [
    ...
    componentClass(
      'q-stepper__tab--active',
      qe`[color:var(--q-primary)] dark:[color:var(--q-primary)] [&_.q-stepper__dot]:([text-shadow:0_0_0_currentColor]) 
      [&_.q-stepper__label]:([text-shadow:0_0_0_currentColor])`
    )
  ],
...
_.q-stepper__tab:last-child]:(items-end) [&_.q-stepper__tab]:(px-[0] py-[24px]) [&_.q-stepper__tab:first-child_.q-stepper__dot]:([transform:translateX(24px)]) [&_.q-stepper__tab:last-child_.q-stepper__dot]:(-[transform:translateX(24px)]) [&_.q-stepper__dot]:(m-0) [&_.q-stepper__label]:(hidden)`
  ...
  [
    ...
    componentClass(
      'q-stepper--horizontal',
      qe`[&_.q-stepper__step-inner]:(p-[24px]) 
      [&_.q-stepper__tab:first-child]:([border-top-left-radius:inherit]) 
      [&_.q-stepper__tab:last-child]:([border-top-right-radius:inherit]) 
      [&_.q-stepper__tab:first-child_.q-stepper__dot:before]:(hidden) 
      [&_.q-stepper__tab:last-child_.q-stepper__label:after]:(hidden) 
      [&_.q-stepper__tab:last-child_.q-stepper__dot:after]:(hidden) 
      [&_.q-stepper__tab]:(overflow-hidden) 
      [&_.q-stepper__line]:(contain-layout) 
      [&_.q-stepper__line:before]:(absolute top-2/4 h-px w-screen bg-[rgba(0,_0,_0,_0.12)]) 
      [&_.q-stepper__line:after]:(absolute top-2/4 h-px w-screen bg-[rgba(0,_0,_0,_0.12)]) [&_.q-stepper__label:after]:(content-[''] left-full ml-[8px]) [&_.q-stepper__dot:after]:(content-[''] left-full ml-[8px]) [&_.q-stepper__dot:before]:(content-[''] right-full mr-[8px]) [&_>_.q-stepper__nav]:(pt-[0] [padding-inline:var(--q-space-xl)] pb-[24px])`
    )
  ],
