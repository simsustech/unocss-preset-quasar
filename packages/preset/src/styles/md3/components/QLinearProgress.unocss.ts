...
const shortcuts: Shortcut<QuasarTheme>[] = [
  ...
  [/^q-linear-progress__model$/, mdStatic(`origin-[0_0]`)],

  [
    /^q-linear-progress__track$/,
    mdComponent('q-linear-progress__track', `origin-[0_0] opacity-40`)
  ],
  ...
  [
    ...
    mdComponent('q-linear-progress__model--determinate', `bg-current`)
  ],
  ...
  [
    ...
    mdComponent('q-linear-progress__track--light', `bg-[rgba(0,_0,_0,_0.26)]`)
  ],
